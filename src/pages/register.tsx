...
import { Calculator, Shield, UserPlus, Sparkles, Eye, EyeOff } from "lucide-react";
        ...
        <div className="hidden md:block space-y-6 animate-in fade-in slide-in-from-left duration-700">
          ...
          <div className="space-y-4 pt-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold mb-1">Akun Gratis</h3>
                <p className="text-sm text-muted-foreground">
                  Daftar sekarang dan mulai kelola trading Anda tanpa biaya
                </p>
              </div>
            </div>
        ...
        <div className="animate-in fade-in slide-in-from-right duration-700">
          <Card className="w-full shadow-xl border-2">
            <CardHeader className="text-center space-y-4 pb-6">
              ...
              <CardTitle className="text-2xl font-bold hidden md:block">Buat Akun</CardTitle>
              <CardDescription className="text-base">
                Daftar untuk mulai mengelola trading Anda
              </CardDescription>
            </CardHeader>
